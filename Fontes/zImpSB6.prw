...
Static Function fRepPrint(oReport)
	...
	aAux := {}
	u_zMemoToArr(cMensagem, @aAux, 200, '<br>')
...
/*/{Protheus.doc} zMemoToArr
Função Memo To Array, que recebe o Texto, o Array por referência, e o máximo de colunas
@author Atilio
@since 12/08/2015
@version 1.0
	@param cTexto, Caracter, Texto que será quebrado (campo MEMO)
	@param aTexto, Array, Array que irá conter as linhas do texto (já quebrado)
	@param nMaxCol, Numérico, Coluna máxima permitida de caracteres
	@param cCaracer, Caracter, Caracter ou string que quebra o tamanho do memo
	@return nMaxLin, Número de linhas do array
	@example
	//Quebrando o memo para array, conforme uma quantidade de colunas
	U_zMemoToArr( cCampoMemo, @aImpr, nCol)
/*/

User Function zMemoToArr(cTexto, aTexto, nMaxCol, cCaracter)
