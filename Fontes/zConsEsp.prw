...
@version 1.0
	...
	@param aColsM, Array, Conteúdo de campos especÃ­ficos, que iniciam com XX_ no aCamposM
	...
	Caso seja necessário incluir campos especÃ­ficos na grid, utilize o prefixo XX_ antes do nome do campo no aCamposM,
