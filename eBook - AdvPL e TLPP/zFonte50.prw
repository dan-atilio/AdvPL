...
/*/{Protheus.doc} zFonte50
Exemplo de geração de relatório com FWMSPrinter (cor de fundo)
@author Atilio
@since 11/12/2022
@version 1.0
@type function
...
Static Function fMontaRel()
    ...
    If lJob
        ...
        cArquivo := "zFonte50_job_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-') + ".pdf"
    ...
    Else
        ...
        cArquivo  := "zFonte50_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-')
