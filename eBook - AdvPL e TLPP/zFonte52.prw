...
/*/{Protheus.doc} zFonte52
Exemplo de geração de relatório com FWMSPrinter (linhas zebradas)
@author Atilio
@since 11/12/2022
@version 1.0
@type function
...
Static Function fMontaRel()
    ...
    If ! QRY_REL->(EoF())
        ...
        If lJob
            ...
            cArquivo := "zFonte52_job_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-') + ".pdf"
        ...
        Else
            ...
            cArquivo  := "zFonte52_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-')
...
Static Function fImpRod()
	...
	//Dados da Esquerda
	cTexto := dToC(dDataGer)+"     "+cHoraGer+"     "+FunName()+" (zFonte52)     "+cUserName
