...
/*/{Protheus.doc} zFonte49
Exemplo de geração de relatório com FWMSPrinter (cores nos textos)
@author Atilio
@since 28/11/2022
@version 1.0
@type function
...
Static Function fMontaRel()
    ...
    If lJob
        ...
        cArquivo := "zFonte49_job_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-') + ".pdf"
    ...
    Else
        ...
        cArquivo  := "zFonte49_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-')
