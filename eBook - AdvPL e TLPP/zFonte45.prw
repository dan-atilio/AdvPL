...
/*/{Protheus.doc} zFonte45
Exemplo de geração de relatório com FWMSPrinter (impressão de textos com Say)
@author Atilio
@since 28/11/2022
@version 1.0
@type function
...
Static Function fMontaRel()
    ...
    If lJob
        ...
        cArquivo := "zFonte45_job_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-') + ".pdf"
    ...
    Else
        ...
        cArquivo  := "zFonte45_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-')
