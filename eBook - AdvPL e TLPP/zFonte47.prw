...
/*/{Protheus.doc} zFonte47
Exemplo de geração de relatório com FWMSPrinter (impressão de QRCode)
@author Atilio
@since 28/11/2022
@version 1.0
@type function
...
Static Function fMontaRel()
    ...
    If lJob
        ...
        cArquivo := "zFonte47_job_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-') + ".pdf"
    ...
    Else
        ...
        cArquivo  := "zFonte47_" + dToS(dDataGer) + "_" + StrTran(cHoraGer, ':', '-')
