...
User Function zExe502()
    ...
    Local cJanTitulo    := 'Exemplo TPanel'
    Local lDimPixels    := .T. 
    Local lCentraliz    := .T. 
    Local nObjLinha     := 0
    Local nObjColun     := 0
    ...
    oDialogPvt := TDialog():New(0, 0, nJanAltura, nJanLargur, cJanTitulo, , , , , , nCorFundo, , , lDimPixels)
        ...
        oPanCampo := TPanel():New(nObjLinha, nObjColun, '', oDialogPvt, /*oFont*/, /*lCentered*/, /*uParam7*/, /*nClrText*/, RGB(255,200,200), nObjLargu, nObjAltur)
        ...
        oPanBotao := TPanel():New(nObjLinha, nObjColun, '', oDialogPvt, /*oFont*/, /*lCentered*/, /*uParam7*/, /*nClrText*/, RGB(200,200,255), nObjLargu, nObjAltur)
