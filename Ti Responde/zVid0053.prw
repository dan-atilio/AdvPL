/*
    ...
    Confira o artigo sobre esse assunto, no seguinte link: https://terminaldeinformacao.com/2023/04/24/pegar-o-valor-de-um-campo-totalizador-mvc-ti-responde-053/ 
...
/*/{Protheus.doc} User Function zVid0053
Exemplo de Modelo X
...
Menu de opcoes na funcao zVid0053
@author Daniel Atilio
@since 04/02/2022
@version 1.0
@type function
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE "Visualizar" ACTION "VIEWDEF.zVid0053" OPERATION 1 ACCESS 0
	ADD OPTION aRotina TITLE "Incluir" ACTION "VIEWDEF.zVid0053" OPERATION 3 ACCESS 0
	ADD OPTION aRotina TITLE "Alterar" ACTION "VIEWDEF.zVid0053" OPERATION 4 ACCESS 0
	ADD OPTION aRotina TITLE "Excluir" ACTION "VIEWDEF.zVid0053" OPERATION 5 ACCESS 0

Return aRotina

/*/{Protheus.doc} ModelDef
Modelo de dados na funcao zVid0053
@author Daniel Atilio
@since 04/02/2022
@version 1.0
@type function
...
Static Function ModelDef()
	...
	oModel := MPFormModel():New("zVid53M", bPre, bPos, bCommit, bCancel)
...
Visualizacao de dados na funcao zVid0053
@author Daniel Atilio
@since 04/02/2022
@version 1.0
@type function
...
Static Function ViewDef()
	Local oModel     := FWLoadModel("zVid0053")
	...
	oView:addUserButton("* Mensagem", "MAGIC_BMP", {|| u_zVid53Ms()}, , , , .T.)

Return oView

/*/{Protheus.doc} User Function zVid53Ms
Mostra uma mensagem demonstrando em como pegar os totalizadores
@type  Function
@author Atilio
@since 26/08/2022
/*/

User Function zVid53Ms()
	Local oModelPad := FWModelActive()
	Local oModelTot := oModelPad:GetModel("TOTAIS")
	Local nTotMusic := oModelTot:GetValue("XX_TOTMUS")
	Local nTotCDs   := oModelTot:GetValue("XX_TOTCDS")

	FWAlertInfo("Total de Músicas: " + cValToChar(nTotMusic) + CRLF + "Total de CDs:" + cValToChar(nTotCDs), "Atenção")
Return
