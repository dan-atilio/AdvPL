/*
    ...
    Confira o artigo sobre esse assunto, no seguinte link: https://terminaldeinformacao.com/2023/05/15/alterar-titulo-de-um-campo-em-mvc-ti-responde-056/ 
...
/*/{Protheus.doc} User Function zVid0056
Exemplo de Modelo X
...
Menu de opcoes na funcao zVid0056
@author Daniel Atilio
@since 04/02/2022
@version 1.0
@type function
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE "Visualizar" ACTION "VIEWDEF.zVid0056" OPERATION 1 ACCESS 0
	ADD OPTION aRotina TITLE "Incluir" ACTION "VIEWDEF.zVid0056" OPERATION 3 ACCESS 0
	ADD OPTION aRotina TITLE "Alterar" ACTION "VIEWDEF.zVid0056" OPERATION 4 ACCESS 0
	ADD OPTION aRotina TITLE "Excluir" ACTION "VIEWDEF.zVid0056" OPERATION 5 ACCESS 0

Return aRotina

/*/{Protheus.doc} ModelDef
Modelo de dados na funcao zVid0056
@author Daniel Atilio
@since 04/02/2022
@version 1.0
@type function
...
Static Function ModelDef()
	...
	oModel := MPFormModel():New("zVid56M", bPre, bPos, bCommit, bCancel)
...
Visualizacao de dados na funcao zVid0056
@author Daniel Atilio
@since 04/02/2022
@version 1.0
@type function
...
Static Function ViewDef()
	Local oModel     := FWLoadModel("zVid0056")
    ...
    //Alterando o título de exibição de alguns campos
    oStruPai:SetProperty("ZD1_NOME",     MVC_VIEW_TITULO, "Nome do Artista *****")
    oStruFilho:SetProperty("ZD2_NOMECD", MVC_VIEW_TITULO, "Nome do CD *****")
    oStruNeto:SetProperty("ZD3_MUSICA",  MVC_VIEW_TITULO, "Nome da Música *****")
